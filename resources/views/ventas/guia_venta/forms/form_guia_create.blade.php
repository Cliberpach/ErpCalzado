<form action="" method="post" id="formRegistrarGuia">
    ...
    <div class="row mb-3">
        ...
        <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
            <div class="form-group">
                <label style="font-weight: bold;" class="required" for="condicion_id">ALMACÉN DE LA VENTA</label>
                <select disabled required onchange="cambiarAlmacen(this.value)"  id="almacen" name="almacen" class="select2_form form-control" required>
                    ...
                    @foreach ($almacenes as $almacen)
                        <option
                        @if ($almacen->id == $venta->almacen_id)
                            selected
                        @endif
                        value="{{ $almacen->id }}">
                            {{ $almacen->descripcion }}
    ...
    @include('ventas.guia_venta.subforms.sub_transporte_publico')
    @include('ventas.guia_venta.subforms.sub_ubigeo')
