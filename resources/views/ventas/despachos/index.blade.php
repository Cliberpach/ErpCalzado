...
@section('bread-submodule', 'Despachos')
@section('hero-title', 'Lista de Despachos')
@section('hero-subtitle', 'Despachos')
                ...
                <div class="ibox ">
                    <div class="ibox-content">
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                <label for="filtroOrigen" style="font-weight: bold;">ORIGEN:</label>
                                <select id="filtroOrigen" class="form-control select2_form">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                <label for="filtroFechaDespachoInicio" style="font-weight: bold;">FEC DESPACHO
                                    INICIO:</label>
                                <input value="<?php echo date('Y-m-d'); ?>" type="date" class="form form-control"
                ...
                "columns": [{
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            if (data === 'WEB') {
                                return `<span class="badge badge-info"><i class="fa fa-globe"></i> WEB</span>`;
                            }
                            return `<span class="badge badge-secondary"><i class="fa fa-store"></i> TIENDA</span>`;
                        }
                    },
                    {
                        data: 'documento_nro',
