                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            <div class="row">
                                <div class="col-12 col-md-6 mb-2">
                                    ...
                                    <span style="color:rgb(251, 135, 135);"
                                        class="error_mdl_client_tipo_documento"></span>
                                </div>
                                <div class="col-12 col-md-6 mb-2">
                                    <div class="form-group m-0">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6 mb-2">
                                    ...
                                    <span style="color:rgb(251, 135, 135);"
                                        class="error_mdl_client_tipo_cliente_id"></span>
                                </div>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            <div class="row">
                                <div class="col-12 col-md-6 mb-2">
                                    ...
                                    <span style="color:rgb(251, 135, 135);"
                                        class="error_mdl_client_departamento"></span>
                                </div>
                                <div class="col-12 col-md-6 mb-2">
                                    <div class="form-group m-0">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 mb-2">
                                    ...
                                    <span style="color:rgb(251, 135, 135);"
                                        class="error_mdl_client_telefono_movil"></span>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
