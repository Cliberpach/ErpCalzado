    ...
    <div class="row">
            ...
            <div class="form-group">
                ...
                <select id="condicion_id" name="condicion_id"
                    ...
                    @foreach ($condiciones as $condicion)
                        <option @if ($condicion->id === $cotizacion->condicion_id) selected @endif value="{{ $condicion->id }}">
        ...
        <div class="col-12 col-lg-3 col-md-3 mb-3">
            ...
            <div class="input-group">
                ...
                <input maxlength="9" value="{{ $cotizacion->telefono }}" placeholder="Ingrese un teléfono"
                    name="telefono" id="telefono" type="text" class="form-control" placeholder="Username"
