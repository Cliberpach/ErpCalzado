...
<script>
    ...
    function guardarEnvio(formDespacho) {
        ...
        if ($("#sede_envio").find('option:selected').text() === "" && window.tipoEnvioSelect.getValue() != 189) {
    ...
    function limpiarMdlEnvio() {
        ...
        //window.provinciaSelect.setValue(null);
        //window.distritoSelect.setValue(null);
        window.tipoEnvioSelect.setValue(null);
        window.tipoPagoEnvioSelect.setValue(null);
