...
@section('hero-title', 'Atender Pedido')
    ...
    <script>
        ...
        function pintarHistorialAtencionPedido() {
            ...
            pedido_detalles.forEach((pd) => {
                filas += `<tr>
                            ...
                            <td>${parseFloat(pd.cantidad).toFixed(2)}</td>
                            <td>${parseFloat(pd.cantidad_atendida).toFixed(2)}</td>
                            <td>${parseFloat(pd.cantidad_pendiente).toFixed(2)}</td>
                            <td>${parseFloat(pd.cantidad_enviada).toFixed(2)}</td>
                            <td>${parseFloat(pd.cantidad_devuelta).toFixed(2)}</td>
                            <td>${parseFloat(pd.cantidad_fabricacion).toFixed(2)}</td>
                        </tr>`;
            })
        ...
        function pintarDetallePedido(carrito) {
            ...
            carrito.forEach((c) => {
                ...
                fila += `<tr>
                            <th>
                                <div style="min-width:150px;">${c.producto_nombre}</div>
                            </th>
                            <th>
                                <div style="min-width:150px;">${c.color_nombre}</div>
                            </th>
                        `;
