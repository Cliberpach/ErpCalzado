...
<div class="row">
    ...
    <div class="col-12 col-lg-3 col-md-3 mb-3">
        ...
        <div class="input-group">
            ...
            <input value="{{$pedido->user_nombre}}" readonly name="registrador" id="registrador" type="text" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1">
        </div>
    </div>
    ...
    <div class="col-12 col-lg-3 col-md-3 mb-3">
        ...
        <div class="input-group">
            ...
            <input value="{{$pedido->fecha_registro}}" readonly name="fecha_registro" id="fecha_registro" type="date" class="form-control">
        </div>
    </div>
    ...
    <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
        <div class="form-group">
            ...
            @if ($pedido->estado === 'ATENDIENDO')
                disabled
            @endif
            onchange="cambiarAlmacen(this.value)"  id="almacen" name="almacen" class="select2_form form-control" required>
                <option></option>
                @foreach ($almacenes as $almacen)
                    <option
                    @if ($almacen->id == $pedido->almacen_id)
                        selected
                    @endif
                    value="{{ $almacen->id }}">
                        {{ $almacen->descripcion }}
    ...
    <div class="col-lg-4 col-md-3 col-sm-12 col-xs-12" style="display: flex;flex-direction:column;justify-content:center;">
        ...
        <div class="d-flex align-items-end">
            <input value="{{$pedido->fecha_propuesta}}" required type="date" class="form-control" id="fecha_propuesta" name="fecha_propuesta">
        </div>
        ...
        <div class="form-group">
            ...
            <select id="cliente" name="cliente"
                ...
                @foreach ($clientes as $cliente)
                    <option @if ($cliente->id == $pedido->cliente_id) selected @endif 
                    value="{{ $cliente->id }}">
