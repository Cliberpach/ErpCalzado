...
@section('hero-title', 'Lista de Detalles Pedidos')
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row mb-3">
            ...
            <div class="col-3 d-flex align-items-end justify-content-end">
                <a class="btn btn-success" href="javascript:void(0);" onclick="exportarExcel()">
    ...
    <script>
        ...
        function loadDataTablePedidoDetalles() {
            dataTablePedidoDetalles = $('#pedidos_detalles').DataTable({
                ...
                "language": {
                    "search": "Buscar código, cliente nombre/doc/tel, producto, color, talla:",
        ...
        function exportarExcel() {
            const estado    = $('#pedido_detalle_estado').val() || '-';
            const clienteId = $('#filtroCliente').val() || '-';
            const url = route('pedidos.pedidos_detalles.getExcel', {
                pedido_detalle_estado: estado,
