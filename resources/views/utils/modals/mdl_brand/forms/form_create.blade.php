<form action="" id="formCreateBrand" method="POST">
    ...
    <div class="row">
        ...
        <!-- NOMBRE -->
        <div class="col-md-6">
            <label for="descripcion_brand" class="required_field mb-2" style="font-weight: 600;">
                <i class="fas fa-warehouse text-primary mr-1"></i>
                Nombre
            </label>

            <input required maxlength="191" id="descripcion_brand" name="descripcion_brand" type="text"
            ...
            <span class="descripcion_brand_error msgError"></span>
        </div>

        <!-- PROCEDENCIA -->
        <div class="col-md-6">
            <label for="procedencia_brand" class="mb-2" style="font-weight: 600;">
                <i class="fas fa-map-marker-alt text-info mr-1"></i>
                Procedencia
            </label>

            <input maxlength="191" id="procedencia_brand" name="procedencia_brand" type="text"
            ...
            <span class="procedencia_brand_error msgError"></span>
        </div>
