        ...
        "columns": [
            ...
            },
            {
                ...
                render: function(data) {
                    ...
                    {
                        @can('haveaccess', 'ventas.guia.enviar_sunat')
...
function enviarSunat(id , sunat) {
    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            // Formulario efímero: la ruta es POST y exige token CSRF. Se mantiene la
            // navegación completa (misma experiencia que antes), pero la URL ya no es
            // reejecutable desde el historial ni compartible.
            enviarPorPost(url);
