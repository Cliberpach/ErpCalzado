...
@section('consulta-ventas-alertas-retenciones-active', 'active')

<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12 col-md-12">
       <h2  style="text-transform:uppercase"><b>Listado de Retenciones no enviadas</b></h2>
        <ol class="breadcrumb">
            ...
            <div class="ibox ">
                <div class="ibox-content">
                    <div class="table-responsive">
                        <table class="table dataTables-retenciones table-striped table-bordered table-hover" style="text-transform:uppercase">
                            <thead>
                                <tr>
...
function loadTable()
{
    $('.dataTables-retenciones').dataTable().fnDestroy();
    $('.dataTables-retenciones').DataTable({
        ...
        "bAutoWidth": false,
        "processing": true,
        "ajax": "{{ route('consultas.ventas.alerta.getTableRetenciones') }}",
        "columns": [
            {
                data: null,
            ...
            },
            {
                data: "fechaEmision",
                className: "text-center letrapequeña",
                name: "retencions.fechaEmision"
            },
            {
                data: "rznSocial",
                className: "text-center letrapequeña",
                name: "retencions.rznSocial"
            },
            {
                data: null,
                className: "text-center letrapequeña",
...
$(".dataTables-retenciones").on('click','.btn-pdf',function(){
    var data = $(".dataTables-retenciones").dataTable().fnGetData($(this).closest('tr'));
...
function enviarSunat(id , sunat) {
    ...
    Swal.fire({
        ...
        text: "¿Seguro que desea enviar retención a Sunat?",
        ...
        if (result.value) {
            ...
            Swal.fire({
                title: '¡Cargando!',
                type: 'info',
                text: 'Enviando retenciones a Sunat',
