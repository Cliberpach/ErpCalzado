<div class="modal inmodal" id="modal_crear_talla" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content animated bounceInRight">
            ...
            <div class="modal-body">
                <form role="form" action="{{route('almacenes.tallas.store')}}" method="POST" id="crear_talla">
