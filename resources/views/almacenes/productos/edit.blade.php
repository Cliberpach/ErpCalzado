                            ...
                            <div class="col-lg-6 col-xs-12">
                                ...
                                {{-- <div class="form-group row d-none">
                                    <div class="col-lg-6 col-xs-12">
                                        ...
                                        <input type="text" id="precio_venta_minimo" name="precio_venta_minimo" class="form-control {{ $errors->has('precio_venta_minimo') ? ' is-invalid' : '' }}" value="{{ old('precio_venta_minimo', $producto->precio_venta_minimo) }}" maxlength="15" onkeypress="return filterFloat(event, this);">
                                    ...
                                    <div class="col-lg-6 col-xs-12">
                                        ...
                                        <input type="precio_venta_maximo" id="precio_venta_maximo" name="precio_venta_maximo" class="form-control {{ $errors->has('precio_venta_maximo') ? ' is-invalid' : '' }}" value="{{ old('precio_venta_maximo', $producto->precio_venta_maximo) }}" maxlength="15" onkeypress="return filterFloat(event, this);">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12 row">
                                                <div class="col-md-12 col-12">
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            <label> <input type="checkbox" {{ old('facturacion_producto',$producto->facturacion) =="SI" ? "checked" : "" }} class="i-checks"  value="SI"> <b class="text-danger">Facturado (SI/NO)</b> </label>
                                                        </div>
                                                    </div>
                                                    <input type="hidden" name="facturacion_producto" id="facturacion_producto" value="{{ old('facturacion_producto',$producto->facturacion) }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="almacen" name="almacen" value="{{old('almacen', $producto->almacen_id)}}"class="select2_form form-control {{ $errors->has('almacen') ? ' is-invalid' : '' }}">
                                                ...
                                                @foreach($almacenes as $almacen)
                                                    <option value="{{ $almacen->id }}" {{ (old('almacen', $producto->almacen_id) == $almacen->id ? "selected" : "") }} >{{ $almacen->descripcion }}</option>
                                                @endforeach
                                            </select>
