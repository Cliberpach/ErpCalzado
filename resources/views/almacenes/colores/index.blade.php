...
@include('almacenes.colores.edit')
...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-lg-2 col-md-2">
        <a data-toggle="modal" data-target="#modal_crear_color"  class="btn btn-block btn-w-m btn-primary m-t-md" href="#">
...
<script>
    ...
    @if ($errors->has('descripcion') )
        $('#modal_editar_color').modal({ show: true });
    @endif
    ...
    $('#modal_editar_color').on('hidden.bs.modal', function(e) {
        limpiarError()
    });

    //Old Modal Crear
    @if ($errors->has('descripcion_guardar') )
        $('#modal_crear_color').modal({ show: true });
    @endif
    ...
    $('#modal_crear_color').on('hidden.bs.modal', function(e) {
        guardarError()
    ...
    function eliminar(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                //Ruta Eliminar
                var url_eliminar = '{{ route("almacenes.colores.destroy", ":id")}}';
    ...
    $('#editar_color').submit(function(e){
        e.preventDefault();
        const swalWithBootstrapButtons = Swal.mixin({
            customClass: {
                container: 'my-swal',
