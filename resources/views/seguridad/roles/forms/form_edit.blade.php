<form method="POST" id="form_edit_role">
    @csrf
    ...
    <div class="row">
                ...
                <div class="card-header bg-success text-white">
                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div>
                            ...
                            <a href="{{ route('seguridad.role.index') }}" class="btn btn-outline-light btn-sm">

                                <i class="fas fa-arrow-left mr-1"></i>
                                Regresar
                            </a>

                            <button type="submit" class="btn btn-light btn-sm text-success font-weight-bold">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-6 col-md-12 mb-3">
                            <div class="border rounded p-3 h-100 bg-light">
                                ...
                                <div class="custom-control custom-radio mb-2">
                                    <input type="radio" id="full-access-si" name="full-access" value="SI"
                                        class="custom-control-input"
                                        {{ old('full-access') ? (old('full-access') == 'SI' ? 'checked' : '') : ($role['full-access'] == 'SI' ? 'checked' : '') }}>

                                    <label class="custom-control-label" for="full-access-si">
                                        SI
                                    </label>
                                </div>

                                <div class="custom-control custom-radio">
                                    <input type="radio" id="full-access-no" name="full-access" value="NO"
                                        class="custom-control-input" @if (old('full-access') == null && $role['full-access'] == null) checked @endif
                                        {{ old('full-access') ? (old('full-access') == 'NO' ? 'checked' : '') : ($role['full-access'] == 'NO' ? 'checked' : '') }}>

                                    <label class="custom-control-label" for="full-access-no">
                                        NO
                                    </label>
                                </div>
                        ...
                        <div class="col-lg-6 col-md-12 mb-3">
                            <div class="border rounded p-3 h-100 bg-light">
                                ...
                                <div class="custom-control custom-radio mb-2">
                                    <input type="radio" id="punto-venta-si" name="punto-venta" value="SI"
                                        class="custom-control-input"
                                        {{ old('punto-venta') ? (old('punto-venta') == 'SI' ? 'checked' : '') : ($role['punto-venta'] == 'SI' ? 'checked' : '') }}>

                                    <label class="custom-control-label" for="punto-venta-si">
                                        SI
                                    </label>
                                </div>

                                <div class="custom-control custom-radio">
                                    <input type="radio" id="punto-venta-no" name="punto-venta" value="NO"
                                        class="custom-control-input" @if (old('punto-venta') == null && $role['punto-venta'] == null) checked @endif
                                        {{ old('punto-venta') ? (old('punto-venta') == 'NO' ? 'checked' : '') : ($role['punto-venta'] == 'NO' ? 'checked' : '') }}>

                                    <label class="custom-control-label" for="punto-venta-no">
                                        NO
                                    </label>
                                </div>
        ...
        <div class="col-12">
            ...
            <div class="card shadow-sm border-0 mb-4" id="cardPermisos">
        ...
        <div class="card-body">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-12 text-lg-right text-center">
                    ...
                    <a href="{{ route('seguridad.role.index') }}" id="btn_cancelar"
                    ...
                    <button type="submit" id="btn_grabar" class="btn btn-success px-4">
