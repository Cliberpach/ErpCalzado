                                ...
                                <div class="col-lg-6 col-xs-12 b-r">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6 col-xs-12">
                                            ...
                                            <input type="text" id="name" name="name"
                                                class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }} text-uppercase"
                                                value="{{ old('name') ? old('name') : $role->name }}" maxlength="50" required
                                                disabled>
                                            @if ($errors->has('name'))
                                        ...
                                        <div class="col-lg-6 col-xs-12">
                                            ...
                                            <input type="text" id="slug"
                                                class="form-control {{ $errors->has('slug') ? ' is-invalid' : '' }} text-uppercase"
                                                name="slug" value="{{ old('slug') ? old('slug') : $role->slug }}"
                                                disabled>
                                            @if ($errors->has('slug'))
                                                <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" id="description" cols="30" rows="3"
                                            class="form-control {{ $errors->has('description') ? ' is-invalid' : '' }}" required disabled>{{ old('description') ? old('description') : $role->description }}</textarea>
                                        ...
                                        <div class="col-lg-12 col-xs-12">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6 col-xs-6">
                                                    <div class="radio">
                                                        <input type="radio" name="full-access" id="full-access-si"
                                                            value="SI"
                                                ...
                                                <div class="col-sm-6 col-xs-6">
                                                    <div class="radio">
                                                        <input type="radio" name="full-access" id="full-access-no"
                                                            value="NO" @if (old('full-access') == null && $role['full-access'] == null) checked @endif
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-12 col-xs-12">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6 col-xs-6">
                                                    <div class="radio">
                                                        <input type="radio" name="punto-venta" id="punto-venta-si"
                                                            value="SI"
                                                            {{ old('punto-venta') ? (old('punto-venta') == 'SI' ? 'checked' : '') : ($role['punto-venta'] == 'SI' ? 'checked' : '') }}
                                                            disabled>
                                                        <label for="punto-venta-si"
                                                            title="Acceso a cualquier caja aperturada.">
                                                            SI
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6 col-xs-6">
                                                    <div class="radio">
                                                        <input type="radio" name="punto-venta" id="punto-venta-no"
                                                            value="NO" @if (old('punto-venta') == null && $role['punto-venta'] == null) checked @endif
                                                            {{ old('punto-venta') ? (old('punto-venta') == 'NO' ? 'checked' : '') : ($role['punto-venta'] == 'NO' ? 'checked' : '') }}
                                                            disabled>
                                                        <label for="punto-venta-no"
                                                            title="Sin acceso a cualquier caja aperturada.">
                                                            NO
                                                        </label>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-lg-6 col-xs-6">
                                                        <div class="checkbox">
                                                            <input type="checkbox" id="permission{{ $permission->id }}"
                                                                ...
                                                                @if (is_array($permission_role) && in_array("$permission->id", $permission_role)) checked
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6 text-right">
                                            ...
                                            <a href="{{ route('role.edit', $role->id) }}" id="btn_grabar"
