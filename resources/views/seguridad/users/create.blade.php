...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10 col-md-10">
       <h2  style="text-transform:uppercase"><b>CREAR USUARIO</b></h2>
        <ol class="breadcrumb">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-xs-12 b-r">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="usuario" name="usuario" class="form-control {{ $errors->has('usuario') ? ' is-invalid' : '' }} text-uppercase" value="{{old('usuario') ? old('usuario') : ''}}{{session('usuario') ? session('usuario') : ''}}" maxlength="50" required>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="password" id="password" class="form-control {{ session('password') ? ' is-invalid' : '' }} text-uppercase" name="password" value="{{session('password')}}" required>
                                            <span class="input-group-append"><button type="button" onclick="password1()" class="btn btn-default"><i id="pass" class="fa fa-eye"></i></button></span>
                                            @if (session('password'))
                                            <span class="invalid-feedback" role="alert">
