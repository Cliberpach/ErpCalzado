                                ...
                                <div class="col-lg-6 col-xs-12 b-r">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="usuario" name="usuario"
                                            ...
                                            value="{{ old('usuario') ? old('usuario') : '' }}{{ session('usuario') ? session('usuario') : '' }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" id="email"
                                            ...
                                            name="email"
                                            value="{{ old('email') ? old('email') : '' }}{{ session('email') ? session('email') : '' }}"
                                            required>
                                        @if ($errors->has('email'))
                                            <span class="invalid-feedback" role="alert">
                                        ...
                                        <select required name="colaborador_id" id="colaborador_id"
                                            ...
                                            @foreach ($colaboradores as $colaborador)
                                                <option value="{{ $colaborador->id }}"
                                                    {{ old('colaborador_id') == $colaborador->id ? 'selected' : '' }}{{ session('colaborador_id') == $colaborador->id ? 'selected' : '' }}>
                                                    {{ $colaborador->nombre }} -
                                                    {{ $colaborador->tipo_documento_nombre . ':' . $colaborador->nro_documento }}
                                                    - {{ $colaborador->sede_nombre }}</option>
                                            @endforeach
                                        </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-append"><button type="button"
                                                        onclick="password1()" class="btn btn-default"><i id="pass"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="password" id="confirm_password"
                                                    ...
                                                    name="confirm_password" value="{{ session('confirm_password') }}"
                                                    required>
                                                <span class="input-group-append"><button type="button"
                                                    ...
                                                    <div class="col-lg-4 col-xs-4">
                                                        <div class="checkbox">
                                                            <input type="checkbox" id="role{{ $role->id }}"
                                                                ...
                                                                @if (is_array(old('role')) && in_array("$role->id", old('role'))) checked
