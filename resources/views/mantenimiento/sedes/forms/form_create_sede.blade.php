...
<form action="" id="formStoreSede" method="post" enctype="multipart/form-data">
    @csrf
    <div class="row">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input maxlength="200" name="urbanizacion" id="urbanizacion" type="text"
                        class="form-control" placeholder="Ingrese urbanización">
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input required maxlength="191" name="codigo_local" id="codigo_local" type="text"
                        class="form-control" placeholder="Ingrese código local">
                </div>
