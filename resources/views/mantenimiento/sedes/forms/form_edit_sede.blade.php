<form action="" id="formActualizarSede" method="post">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 mb-3 d-flex justify-content-center">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mb-3">
                    <label for="img_empresa" style="font-weight:bold;" class="form-label">IMAGEN</label>
                    <input type="file" id="img_empresa" name="img_empresa" accept="image/jpeg,image/webp">
                    <span class="img_empresa_error msgError" style="color:red;"></span>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input value="{{$sede->urbanizacion}}" maxlength="100" value="" name="urbanizacion" id="urbanizacion" type="text" class="form-control" placeholder="URBANIZACIÓN" aria-label="Username" aria-describedby="basic-addon1">
                    </div>
