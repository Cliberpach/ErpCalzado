...
@section('hero-title', 'Editar Colaborador')
                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-footer d-flex justify-content-between align-items-center">
                                        <span style="color:rgb(219, 155, 35);font-size:14px;font-weight:bold;">Los campos
                                            con * son obligatorios</span>

                                        <div style="display:flex;">
                                            <button class="btn btn-danger btnVolver" style="margin-right:5px;"
                                                type="button">
                ...
                if (result.isConfirmed) {
                    ...
                    try {
                        ...
                        let urlUpdateColaborador =
                            `{{ route('mantenimiento.colaborador.update', ['id' => ':id']) }}`;
