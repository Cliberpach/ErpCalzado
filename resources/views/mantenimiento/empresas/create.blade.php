            ...
            <div class="col-lg-12">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        ...
                        <form action="{{ route('mantenimiento.empresas.store') }}" method="POST"
                            enctype="multipart/form-data" id="enviar_empresa">
                            {{ csrf_field() }}
                                    ...
                                    <div class="tabs-container">
                                        <ul class="nav nav-tabs">
                                            <li title="Datos de la Empresa">
                                                <a class="nav-link active" data-toggle="tab" href="#tab-1"><i
                                                        class="fa fa-check-square"></i> Empresa</a>
                                            </li>
                                            <li title="Datos de Entidades Financieras">
                                                <a class="nav-link" data-toggle="tab"href="#tab-2" id="bancos_link"> <i
                                                        class="fa fa-user"></i> Bancos</a>
                                            </li>

                                            <li title="Datos sobre la Facturación Electrónica" id="facturacion_tab"
                                                style="display:none;">
                                                <a class="nav-link" data-toggle="tab"href="#tab-3" id="facturacion_link"> <i
                                                        class="fa fa-file-pdf-o"></i> Facturación Electrónica</a>
                                            </li>
                                        ...
                                        <div class="tab-content">
                                                        ...
                                                        <div class="col-md-6 col-xs-12 b-r">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-6 col-xs-12">
                                                                    <label> Facturación Electrónica: &nbsp<input
                                                                            type="checkbox" class="i-checks" id="estado_fe"
                                                                            name="estado_fe"></label>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <input type="text"
                                                                            ...
                                                                            name="ruc" id="ruc" maxlength="11"
                                                                            value="{{ old('ruc') }}" required>
                                                                        <span class="input-group-append"><a
                                                                                style="color:white" onclick="consultarRuc()"
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input type="text" id="estado"
                                                                        ...
                                                                        name="estado"
                                                                        value="{{ old('estado', 'SIN VERIFICAR') }}"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                @endif
                                                                <div class="invalid-feedback"><b><span
                                                                            id="error-razon_social"></span></b></div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-4 col-xs-12">
                                                                    ...
                                                                    <input type="text" id="ubigeo_empresa"
                                                                        class="form-control {{ $errors->has('ubigeo_empresa') ? ' is-invalid' : '' }}"
                                                                        name="ubigeo_empresa"
                                                                        value="{{ old('ubigeo_empresa') }}">
                                                                    <div class="invalid-feedback"><b><span
                                                                                id="error-empresa_ubigeo"></span></b></div>
                                                                </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <textarea type="text" id="direccion_fiscal" name="direccion_fiscal" required
                                                                        ...
                                                                        value="{{ old('direccion_fiscal') }}" onkeyup="return mayus(this)">{{ old('direccion_fiscal') }}</textarea>
                                                                    ...
                                                                    @endif
                                                                    <div class="invalid-feedback"><b><span
                                                                                id="error-direccion_fiscal"></span></b>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <textarea type="text" id="direccion_llegada" name="direccion_llegada"
                                                                        ...
                                                                        value="{{ old('direccion_llegada') }}" onkeyup="return mayus(this)" required>{{ old('direccion_llegada') }}</textarea>
                                                                    ...
                                                                    @endif
                                                                    <div class="invalid-feedback"><b><span
                                                                                id="error-direccion_llegada"></span></b>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="email"
                                                                    ...
                                                                    id="correo" onkeyup="return mayus(this)">
                                                            ...
                                                            <div class="form-group row justify-content-center">
                                                                <div class="col-6 align-content-center">
                                                                    ...
                                                                    <div class="row justify-content-center">
                                                                        <p>
                                                                            <img class="logo"
                                                                                src="{{ asset('storage/empresas/logos/default.png') }}"
                                                                                alt="">
                                                                            <input id="url_logo" name="url_logo"
                                                                                type="hidden" value="">
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <div class="input-group">
                                                                                <input type="text"
                                                                                    ...
                                                                                    id="dni_representante" maxlength="8"
                                                                                    value="{{ old('dni_representante') }}"
                                                                                    required>
                                                                                <span class="input-group-append"><a
                                                                                        style="color:white"
                                                                                ...
                                                                                @endif
                                                                                <div class="invalid-feedback"><b><span
                                                                                            id="error-dni_representante"></span></b>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <input type="text"
                                                                                ...
                                                                                name="estado_dni_representante"
                                                                                id="estado_dni_representante"
                                                                                onkeyup="return mayus(this)"
                                                                                value="{{ old('estado_dni_representante', 'SIN VERIFICAR') }}"
                                                                                disabled>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        @endif
                                                                        <div class="invalid-feedback"><b><span
                                                                                    id="error-nombre_representante"></span></b>
                                                                        </div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <input type="text"
                                                                                ...
                                                                                name="num_asiento" id="num_asiento"
                                                                                onkeyup="return mayus(this)"
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <input type="text"
                                                                                ...
                                                                                name="num_partida" id="num_partida"
                                                                                onkeyup="return mayus(this)"
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-md-9">
                                                            ...
                                                            <input type="hidden" id="entidades_tabla"
                                                                name="entidades_tabla[]">
                                                        </div>
                                                        <div class="col-md-3">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="table-responsive">
                                                            <table
                                                                class="table dataTables-bancos table-striped table-bordered table-hover"
                                            ...
                                            <div id="tab-3" class="tab-pane">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <input type="hidden" name="certificado_base" id=certificado_base
                                                        value="{{ old('certificado_base') }}">
                                                        ...
                                                        <div class="col-md-6 col-xs-12 b-r">
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-lg-6 col-xs-12">
                                                                    ...
                                                                    <a class="btn btn-primary btn-block modal_certificado"
                                                                        style="color:white"><i class="fa fa-upload"></i>
                                                                        Subir Certificado (.pfx)</a>
                                                                </div>
                                                                <div class="col-lg-6 col-xs-12">
                                                                    <label for="">Estado</label>
                                                                    <input type="text" id="estado_certificado"
                                                                        class="form-control text-center"
                                                                        name="estado_certificado"
                                                                        value="{{ old('estado_certificado', 'SIN VERIFICAR') }}"
                                                                        readonly>
                                                                </div>
                                                        ...
                                                        <div class="col-md-6 col-xs-12">
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-md-6 col-xs-12">
                                                                    ...
                                                                    <input type="text"
                                                                        class="form-control {{ $errors->has('soap_usuario') ? ' is-invalid' : '' }}"
                                                                        name="soap_usuario" id="soap_usuario"
                                                                        value="{{ old('soap_usuario') }}">
                                                                    <div class="invalid-feedback"><b><span
                                                                                id="error-soap_usuario"></span></b></div>
                                                                </div>

                                                                <div class="col-md-6 col-xs-12">
                                                                    <label class="required">Soap Contraseña:</label>
                                                                    <input type="text"
                                                                        class="form-control {{ $errors->has('soap_password') ? ' is-invalid' : '' }}"
                                                                        name="soap_password" id="soap_password"
                                                                        value="{{ old('soap_password') }}">
                                                                    <div class="invalid-feedback"><b><span
                                                                                id="error-soap_password"></span></b></div>
                                                                </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-md-9">
                                                            ...
                                                            <input type="hidden" id="numeracion_tabla"
                                                                name="numeracion_tabla[]">
                                                        </div>
                                                        <div class="col-md-3">
                                                            <a class="btn btn-block btn-primary m-t-md"
                                                                style="color:white;" data-toggle="modal"
                                                                data-target="#modal_numeracion_facturacion">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="table-responsive">
                                                            <table
                                                                class="table dataTables-numeracion table-striped table-bordered table-hover"
                                                                style="text-transform:uppercase">
                                                                <thead>
                                                                    <tr>
                                                                        <th class="text-center">ACCIONES</th>
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                if (validarCertificado() == true) {
                                    ...
                                    if ($('#estado').val() == "ACTIVO" || $('#estado').val() ==
                                        "SIN VERIFICAR") {
                                        ...
                                        toastr.error('Ingrese una empresa activa o sin verificar',
                                            'Error');
                                    }
                                }
