<form action="" id="formAddNumeracionEmpresa">

    <input type="hidden" name="sede_id" value="{{ $sede_principal->id }}">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
            <label class="required" for="parametro" style="font-weight:bold;">PARAMETRO</label>
            <div class="input-group mb-3">
                ...
                <input required id="parametro" name="parametro" readonly type="text" class="form-control" placeholder="Parametro">
            </div>
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 mb-3">
            <label class="required" for="serie" style="font-weight:bold;">CODIGO SERIE</label>
            <div class="input-group">
                ...
                <input required value="" id="serie" name="serie" type="text" class="form-control" placeholder="Serie">
            </div>
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="input-group mb-3">
                ...
                <input value="1" required id="nro_inicio" name="nro_inicio" type="text" class="form-control inputEnteroPositivo" placeholder="N° inicio">
            </div>
