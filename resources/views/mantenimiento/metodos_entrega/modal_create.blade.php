        ...
        <div class="modal-content animated bounceInRight">
            ...
            <div class="modal-footer">
                ...
                <div class="col-md-6 text-right">
                    <button type="submit" class="btn btn-primary btn-sm" form="frmMetodoEntrega"
...
<script>
    function openMdlSedeCreate() {
        if (!document.getElementById('tipo_envio').tomselect) {
            window.tsTipoEnvio = new TomSelect('#tipo_envio', { create: false, allowEmptyOption: false });
        }
        $('#modal_create_metodo_entrega').modal('show');
    }
