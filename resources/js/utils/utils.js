...
window.limpiarErroresValidacion = limpiarErroresValidacion;
window.pintarErroresValidacion = pintarErroresValidacion;
window.getRowById = getRowById;
window.getRowByIndex = getRowByIndex;
window.formatearFecha = formatearFecha;
window.iniciarDataTable = iniciarDataTable;
window.destruirDataTable = destruirDataTable;
