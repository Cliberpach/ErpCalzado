...
Route::prefix('almacenes')->group(function () {
    ...
    Route::prefix('almacen')->group(function () {
        ...
        Route::get('getRepository', 'Almacenes\AlmacenController@getRepository')->name('almacenes.almacen.getRepository');
        Route::delete('destroy/{id}', 'Almacenes\AlmacenController@destroy')->name('almacenes.almacen.destroy');
        Route::post('store', 'Almacenes\AlmacenController@store')->name('almacenes.almacen.store');
        Route::put('update/{id}', 'Almacenes\AlmacenController@update')->name('almacenes.almacen.update');
    ...
    Route::prefix('categorias')->group(function () {
        ...
        Route::get('getAll', 'Almacenes\CategoriaController@getAll')->name('almacenes.categorias.getAll');
        Route::get('getCategory', 'Almacenes\CategoriaController@getCategory')->name('getCategory');
        Route::delete('destroy/{id}', 'Almacenes\CategoriaController@destroy')->name('almacenes.categorias.destroy');
        Route::post('store', 'Almacenes\CategoriaController@store')->name('almacenes.categorias.store');
        Route::put('update/{id}', 'Almacenes\CategoriaController@update')->name('almacenes.categorias.update');
    });

    //Marcas
    Route::prefix('marcas')->group(function () {
        Route::get('index', 'Almacenes\MarcaController@index')->name('almacenes.marcas.index');
        Route::get('getmarca', 'Almacenes\MarcaController@getmarca')->name('almacenes.marcas.getRepository');
        Route::delete('destroy/{id}', 'Almacenes\MarcaController@destroy')->name('almacenes.marcas.destroy');
        Route::post('store', 'Almacenes\MarcaController@store')->name('almacenes.marcas.store');
        Route::put('update/{id}', 'Almacenes\MarcaController@update')->name('almacenes.marcas.update');
    ...
    Route::prefix('modelos')->group(function () {
        ...
        Route::get('getRepository', 'Almacenes\ModeloController@getRepository')->name('almacenes.modelos.getRepository');
        Route::delete('destroy/{id}', 'Almacenes\ModeloController@destroy')->name('almacenes.modelos.destroy');
        Route::post('store', 'Almacenes\ModeloController@store')->name('almacenes.modelos.store');
        Route::put('update/{id}', 'Almacenes\ModeloController@update')->name('almacenes.modelos.update');
    });
    ...
    Route::prefix('tallas')->group(function () {
        ...
        Route::get('getRepository', 'Almacenes\TallaController@getRepository')->name('almacenes.tallas.getRepository');
        Route::delete('destroy/{id}', 'Almacenes\TallaController@destroy')->name('almacenes.tallas.destroy');
        Route::post('store', 'Almacenes\TallaController@store')->name('almacenes.tallas.store');
        Route::put('update/{id}', 'Almacenes\TallaController@update')->name('almacenes.tallas.update');
    });
